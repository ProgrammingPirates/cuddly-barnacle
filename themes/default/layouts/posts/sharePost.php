            ...
            <div class="i_sharing_post_wrapper">
                ...
                <div class="i_post_u_images">
                    ...
                    echo '<div class="'.$container.'" id="lightgallery'.$userPostID.'">';
                        ...
                        ?>
                            <div class="i_post_image_swip_wrapper <?php echo ($fileExtension == 'mp4') ? 'video-container' : ''; ?>" data-bg="<?php echo iN_HelpSecure($filePathUrl); ?>" <?php echo iN_HelpSecure($fileisVideo);?>>
