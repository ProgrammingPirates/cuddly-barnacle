...
if ($currentHour < 12) {
    ...
    $safeName = isset($userFullName) ? $userFullName : '';
    $greetTitle = iN_HelpSecure($LANG['good_morning']) . ', ' . iN_HelpSecure($safeName) .
...
// Afternoon greeting
    ...
    $safeName = isset($userFullName) ? $userFullName : '';
    $greetTitle = iN_HelpSecure($LANG['good_afternoon']) . ', ' . iN_HelpSecure($safeName) .
...
// Evening greeting
    ...
    $safeName = isset($userFullName) ? $userFullName : '';
    $greetTitle = iN_HelpSecure($LANG['good_evening']) . ', ' . iN_HelpSecure($safeName) .
