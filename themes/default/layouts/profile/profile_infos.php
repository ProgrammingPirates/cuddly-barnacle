       ...
       <div class="i_profile_infos_wrapper">
          ...
          <div class="i_u_profile_info">
               ...
               <div class="i_p_item_box flex_ tabing">
                   <div class="i_p_ffs flex_ tabing <?php echo iN_HelpSecure($pCat) == 'following' ? "active_page_menu" : ""; ?>"><a class="flex_ tabing" href="<?php echo iN_HelpSecure($base_url.$p_username.'?pcat=following');?>"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('139'));?> <?php echo iN_HelpSecure($LANG['im_following']);?></a></div>
                   <div class="i_p_ffs flex_ tabing <?php echo iN_HelpSecure($pCat) == 'followers' ? "active_page_menu" : ""; ?>"><a class="flex_ tabing" href="<?php echo iN_HelpSecure($base_url.$p_username.'?pcat=followers');?>"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('140'));?> <?php echo iN_HelpSecure($LANG['my_followers']);?></a></div>
                   <?php if($pCertificationStatus == '2' && $pValidationStatus == '2' && $feesStatus == '2'){ ?>
                   <div class="i_p_ffs i_p_ffs_plus flex_ tabing <?php echo iN_HelpSecure($pCat) == 'subscribers' ? "active_page_menu" : ""; ?>"><a class="flex_ tabing" href="<?php echo iN_HelpSecure($base_url.$p_username.'?pcat=subscribers');?>"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('43'));?> <?php echo iN_HelpSecure($LANG['subscribers']);?></a></div>
                   <?php }?>
               </div>
